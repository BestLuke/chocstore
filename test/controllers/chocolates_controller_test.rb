...
class ChocolatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chocolate" do
    assert_difference('Chocolate.count') do
      post chocolates_url, params: { chocolate: { name: @chocolate.name, price: @chocolate.price, quantity: @chocolate.quantity, sku: @chocolate.sku } }
    end
  ...
  test "should update chocolate" do
    patch chocolate_url(@chocolate), params: { chocolate: { name: @chocolate.name, price: @chocolate.price, quantity: @chocolate.quantity, sku: @chocolate.sku } }
